...
p;10;CPBundle.ji;10;CPObject.ji;14;CPDictionary.ji;14;CPURLRequest.jc;6231;
...
},["void","id"]), new objj_method(sel_getUid("firstEligiblePlatform"), function $CPBundle__firstEligiblePlatform(self, _cmd)
{ with(self)
{
    var platforms = objj_msgSend(self, "objectForInfoDictionaryKey:", "CPBundlePlatforms");
    return objj_msgSend(platforms, "firstObjectCommonWithArray:", OBJJ_PLATFORMS) || nil;
}
...
{ with(self)
{
    if (aConnection === self._infoConnection)
    {
        ...
        var platform = objj_msgSend(self, "firstEligiblePlatform");
        if (!platform)
            throw "Engine not supported for " + objj_msgSend(self, "bundlePath") + ". Supported engines: " + objj_msgSend(self, "objectForInfoDictionaryKey:", "CPBundlePlatforms") + ".";
        objj_msgSend(CPURLConnection, "connectionWithRequest:delegate:", objj_msgSend(CPURLRequest, "requestWithURL:", objj_msgSend(self, "bundlePath") + '/' + platform + ".platform/" + objj_msgSend(self, "objectForInfoDictionaryKey:", "CPBundleExecutable")), self);
    }
    else
    {
        ...
        var files = objj_msgSend(objj_msgSend(self, "objectForInfoDictionaryKey:", "CPBundleReplacedFiles"), "objectForKey:", objj_msgSend(self, "firstEligiblePlatform")),
...
},["CPBundle"]), new objj_method(sel_getUid("firstCompatibleEngineFromArray:"), function $CPBundle__firstCompatibleEngineFromArray_(self, _cmd, engines)
{ with(self)
{
