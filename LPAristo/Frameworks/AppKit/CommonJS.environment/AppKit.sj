...
p;9;CPAlert.jI;21;Foundation/CPObject.jI;21;Foundation/CPString.jI;22;AppKit/CPApplication.jI;17;AppKit/CPButton.jI;16;AppKit/CPColor.jI;15;AppKit/CPFont.jI;16;AppKit/CPImage.jI;20;AppKit/CPImageView.jI;16;AppKit/CPPanel.jI;20;AppKit/CPTextField.jc;5956;
...
p;15;CPApplication.jI;21;Foundation/CPBundle.ji;17;CPCompatibility.ji;9;CPEvent.ji;8;CPMenu.ji;13;CPResponder.ji;22;CPDocumentController.ji;14;CPThemeBlend.ji;14;CPCibLoading.ji;12;CPPlatform.jc;21574;
...
}),new objj_method(sel_getUid("_documentController:didCloseAll:context:"),function(_24,_25,_26,_27,_28){
with(_24){
if(_27){
if(objj_msgSend(_delegate,"respondsToSelector:",sel_getUid("applicationShouldTerminate:"))){
objj_msgSend(_24,"replyToApplicationShouldTerminate:",objj_msgSend(_delegate,"applicationShouldTerminate:",_24));
}else{
objj_msgSend(_24,"replyToApplicationShouldTerminate:",YES);
}
}
}
}),new objj_method(sel_getUid("replyToApplicationShouldTerminate:"),function(_29,_2a,_2b){
with(_29){
if(_2b==CPTerminateNow){
objj_msgSend(objj_msgSend(CPNotificationCenter,"defaultCenter"),"postNotificationName:object:",CPApplicationWillTerminateNotification,_29);
objj_msgSend(CPPlatform,"terminateApplication");
}
}
}),new objj_method(sel_getUid("activateIgnoringOtherApps:"),function(_2c,_2d,_2e){
with(_2c){
objj_msgSend(CPPlatform,"activateIgnoringOtherApps:",_2e);
}
}),new objj_method(sel_getUid("hideOtherApplications:"),function(_2f,_30,_31){
with(_2f){
objj_msgSend(CPPlatform,"hideOtherApplications:",_2f);
}
}),new objj_method(sel_getUid("run"),function(_32,_33){
with(_32){
objj_msgSend(_32,"finishLaunching");
}
}),new objj_method(sel_getUid("runModalForWindow:"),function(_34,_35,_36){
with(_34){
objj_msgSend(_34,"runModalSession:",objj_msgSend(_34,"beginModalSessionForWindow:",_36));
}
}),new objj_method(sel_getUid("stopModalWithCode:"),function(_37,_38,_39){
with(_37){
if(!_currentSession){
return;
}
_currentSession._state=_39;
_currentSession=_currentSession._previous;
objj_msgSend(_37,"_removeRunModalLoop");
}
}),new objj_method(sel_getUid("_removeRunModalLoop"),function(_3a,_3b){
with(_3a){
var _3c=_eventListeners.length;
while(_3c--){
if(_eventListeners[_3c]._callback===_3d){
_eventListeners.splice(_3c,1);
return;
}
}
}
}),new objj_method(sel_getUid("stopModal"),function(_3e,_3f){
with(_3e){
objj_msgSend(_3e,"stopModalWithCode:",CPRunStoppedResponse);
}
}),new objj_method(sel_getUid("abortModal"),function(_40,_41){
with(_40){
objj_msgSend(_40,"stopModalWithCode:",CPRunAbortedResponse);
}
}),new objj_method(sel_getUid("beginModalSessionForWindow:"),function(_42,_43,_44){
with(_42){
return _45(_44,0);
}
}),new objj_method(sel_getUid("runModalSession:"),function(_46,_47,_48){
with(_46){
_48._previous=_currentSession;
_currentSession=_48;
var _49=_48._window;
objj_msgSend(_49,"center");
objj_msgSend(_49,"makeKeyAndOrderFront:",_46);
objj_msgSend(CPApp,"setCallback:forNextEventMatchingMask:untilDate:inMode:dequeue:",_3d,CPAnyEventMask,nil,0,NO);
}
}),new objj_method(sel_getUid("modalWindow"),function(_4a,_4b){
with(_4a){
if(!_currentSession){
return nil;
}
...
}),new objj_method(sel_getUid("_handleKeyEquivalent:"),function(_4c,_4d,_4e){
with(_4c){
return objj_msgSend(objj_msgSend(_4c,"keyWindow"),"performKeyEquivalent:",_4e)||objj_msgSend(_mainMenu,"performKeyEquivalent:",_4e);
}
}),new objj_method(sel_getUid("sendEvent:"),function(_4f,_50,_51){
with(_4f){
_currentEvent=_51;
if(objj_msgSend(_51,"_couldBeKeyEquivalent")&&objj_msgSend(_4f,"_handleKeyEquivalent:",_51)){
objj_msgSend(objj_msgSend(objj_msgSend(_51,"window"),"platformWindow"),"_propagateCurrentDOMEvent:",NO);
return;
}
if(_eventListeners.length){
if(_eventListeners[_eventListeners.length-1]._mask&(1<<objj_msgSend(_51,"type"))){
_eventListeners.pop()._callback(_51);
}
return;
}
objj_msgSend(objj_msgSend(_51,"window"),"sendEvent:",_51);
}
}),new objj_method(sel_getUid("doCommandBySelector:"),function(_52,_53,_54){
with(_52){
if(objj_msgSend(_delegate,"respondsToSelector:",_54)){
objj_msgSend(_delegate,"performSelector:",_54);
}else{
objj_msgSendSuper({receiver:_52,super_class:objj_getClass("CPResponder")},"doCommandBySelector:",_54);
}
}
}),new objj_method(sel_getUid("keyWindow"),function(_55,_56){
with(_55){
return _keyWindow;
}
}),new objj_method(sel_getUid("mainWindow"),function(_57,_58){
with(_57){
return _mainWindow;
}
}),new objj_method(sel_getUid("windowWithWindowNumber:"),function(_59,_5a,_5b){
with(_59){
return _windows[_5b];
}
}),new objj_method(sel_getUid("windows"),function(_5c,_5d){
with(_5c){
return _windows;
}
}),new objj_method(sel_getUid("hide:"),function(_5e,_5f,_60){
with(_5e){
objj_msgSend(CPPlatform,"hide:",_5e);
}
}),new objj_method(sel_getUid("mainMenu"),function(_61,_62){
with(_61){
return _mainMenu;
}
}),new objj_method(sel_getUid("setMainMenu:"),function(_63,_64,_65){
with(_63){
if(objj_msgSend(_65,"_menuName")==="CPMainMenu"){
if(_mainMenu===_65){
return;
}
_mainMenu=_65;
...
objj_msgSend(_65,"_setMenuName:","CPMainMenu");
}
}
}),new objj_method(sel_getUid("orderFrontColorPanel:"),function(_66,_67,_68){
with(_66){
objj_msgSend(objj_msgSend(CPColorPanel,"sharedColorPanel"),"orderFront:",_66);
}
}),new objj_method(sel_getUid("orderFrontStandardAboutPanel:"),function(_69,_6a,_6b){
with(_69){
objj_msgSend(_69,"orderFrontStandardAboutPanelWithOptions:",nil);
}
}),new objj_method(sel_getUid("orderFrontStandardAboutPanelWithOptions:"),function(_6c,_6d,_6e){
with(_6c){
}
}),new objj_method(sel_getUid("tryToPerform:with:"),function(_6f,_70,_71,_72){
with(_6f){
if(!_71){
return NO;
}
if(objj_msgSendSuper({receiver:_6f,super_class:objj_getClass("CPResponder")},"tryToPerform:with:",_71,_72)){
return YES;
}
if(objj_msgSend(_delegate,"respondsToSelector:",_71)){
objj_msgSend(_delegate,"performSelector:withObject:",_71,_72);
return YES;
}
return NO;
}
}),new objj_method(sel_getUid("sendAction:to:from:"),function(_73,_74,_75,_76,_77){
with(_73){
var _78=objj_msgSend(_73,"targetForAction:to:from:",_75,_76,_77);
if(!_78){
return NO;
}
objj_msgSend(_78,"performSelector:withObject:",_75,_77);
return YES;
}
}),new objj_method(sel_getUid("targetForAction:to:from:"),function(_79,_7a,_7b,_7c,_7d){
with(_79){
if(!_7b){
return nil;
}
...
return objj_msgSend(_79,"targetForAction:",_7b);
}
}),new objj_method(sel_getUid("_targetForWindow:action:"),function(_7e,_7f,_80,_81){
with(_7e){
var _82=objj_msgSend(_80,"firstResponder"),_83=YES;
while(_82){
if(objj_msgSend(_82,"respondsToSelector:",_81)){
return _82;
}
if(_82==_80){
_83=NO;
}
_82=objj_msgSend(_82,"nextResponder");
}
if(_83&&objj_msgSend(_80,"respondsToSelector:",_81)){
return _80;
}
var _84=objj_msgSend(_80,"delegate");
if(objj_msgSend(_84,"respondsToSelector:",_81)){
return _84;
}
var _85=objj_msgSend(_80,"windowController");
if(objj_msgSend(_85,"respondsToSelector:",_81)){
return _85;
}
var _86=objj_msgSend(_85,"document");
if(_86!=_84&&objj_msgSend(_86,"respondsToSelector:",_81)){
return _86;
}
return nil;
}
}),new objj_method(sel_getUid("targetForAction:"),function(_87,_88,_89){
with(_87){
if(!_89){
return nil;
}
var _8a=objj_msgSend(_87,"_targetForWindow:action:",objj_msgSend(_87,"keyWindow"),_89);
if(_8a){
return _8a;
}
_8a=objj_msgSend(_87,"_targetForWindow:action:",objj_msgSend(_87,"mainWindow"),_89);
if(_8a){
return _8a;
}
if(objj_msgSend(_87,"respondsToSelector:",_89)){
return _87;
}
if(objj_msgSend(_delegate,"respondsToSelector:",_89)){
return _delegate;
}
if(objj_msgSend(_documentController,"respondsToSelector:",_89)){
return _documentController;
}
return nil;
}
}),new objj_method(sel_getUid("setCallback:forNextEventMatchingMask:untilDate:inMode:dequeue:"),function(_8b,_8c,_8d,_8e,_8f,_90,_91){
with(_8b){
_eventListeners.push(_92(_8e,_8d));
if(_eventListeners.length==3){
objj_debug_print_backtrace();
}
}
}),new objj_method(sel_getUid("setTarget:selector:forNextEventMatchingMask:untilDate:inMode:dequeue:"),function(_93,_94,_95,_96,_97,_98,_99,_9a){
with(_93){
_eventListeners.push(_92(_97,function(_9b){
objj_msgSend(_95,_96,_9b);
}));
}
}),new objj_method(sel_getUid("currentEvent"),function(_9c,_9d){
with(_9c){
return _currentEvent;
}
}),new objj_method(sel_getUid("beginSheet:modalForWindow:modalDelegate:didEndSelector:contextInfo:"),function(_9e,_9f,_a0,_a1,_a2,_a3,_a4){
with(_9e){
var _a5=objj_msgSend(_a0,"styleMask");
if(!(_a5&CPDocModalWindowMask)){
...
objj_msgSend(_a1,"_attachSheet:modalDelegate:didEndSelector:contextInfo:",_a0,_a2,_a3,_a4);
}
}),new objj_method(sel_getUid("endSheet:returnCode:"),function(_a6,_a7,_a8,_a9){
with(_a6){
var _aa=objj_msgSend(_windows,"count");
while(--_aa>=0){
var _ab=objj_msgSend(_windows,"objectAtIndex:",_aa);
var _ac=_ab._sheetContext;
if(_ac!=nil&&_ac["sheet"]===_a8){
_ac["returnCode"]=_a9;
objj_msgSend(_ab,"_detachSheetWindow");
return;
}
}
}
}),new objj_method(sel_getUid("endSheet:"),function(_ad,_ae,_af){
with(_ad){
objj_msgSend(_ad,"endSheet:returnCode:",_af,0);
}
}),new objj_method(sel_getUid("arguments"),function(_b0,_b1){
with(_b0){
if(_fullArgsString!=window.location.hash){
objj_msgSend(_b0,"_reloadArguments");
}
return _args;
}
}),new objj_method(sel_getUid("setArguments:"),function(_b2,_b3,_b4){
with(_b2){
if(!_b4||_b4.length==0){
_args=[];
...
if(objj_msgSend(_b4,"class")!=CPArray){
_b4=objj_msgSend(CPArray,"arrayWithObject:",_b4);
}
_args=_b4;
var _b5=objj_msgSend(_args,"copy");
for(var i=0,_b6=_b5.length;i<_b6;i++){
_b5[i]=encodeURIComponent(_b5[i]);
}
var _b7=objj_msgSend(_b5,"componentsJoinedByString:","/");
window.location.hash="#"+_b7;
}
}),new objj_method(sel_getUid("_reloadArguments"),function(_b8,_b9){
with(_b8){
_fullArgsString=window.location.hash;
var _ba=_fullArgsString.replace("#","").split("/").slice(0);
for(var i=0,_bb=_ba.length;i<_bb;i++){
_ba[i]=decodeURIComponent(_ba[i]);
}
_args=_ba;
}
}),new objj_method(sel_getUid("namedArguments"),function(_bc,_bd){
with(_bc){
return _namedArgs;
}
}),new objj_method(sel_getUid("_openURL:"),function(_be,_bf,_c0){
with(_be){
...
return objj_msgSend(_delegate,"application:openFile:",_be,objj_msgSend(_c0,"absoluteString"));
}
if(_delegate&&objj_msgSend(_delegate,"respondsToSelector:",sel_getUid("application:openURL:"))){
return objj_msgSend(_delegate,"application:openURL:",_be,_c0);
}
return !!objj_msgSend(_documentController,"openDocumentWithContentsOfURL:display:error:",_c0,YES,NULL);
}
}),new objj_method(sel_getUid("_didResignActive"),function(_c1,_c2){
with(_c1){
if(_c1._activeMenu){
objj_msgSend(_c1._activeMenu,"cancelTracking");
}
}
})]);
class_addMethods(_4,[new objj_method(sel_getUid("sharedApplication"),function(_c3,_c4){
with(_c3){
if(!CPApp){
...
var _45=function(_c5,_c6){
return {_window:_c5,_state:CPRunContinuesResponse,_previous:nil};
};
var _92=function(_c7,_c8){
return {_mask:_c7,_callback:_c8};
};
var _3d=function(_c9){
objj_msgSend(CPApp,"setCallback:forNextEventMatchingMask:untilDate:inMode:dequeue:",_3d,CPAnyEventMask,nil,0,NO);
var _ca=objj_msgSend(_c9,"window"),_cb=CPApp._currentSession;
if(_ca==_cb._window||objj_msgSend(_ca,"worksWhenModal")){
objj_msgSend(_ca,"sendEvent:",_c9);
}
};
CPApplicationMain=function(_cc,_cd){
var _ce=objj_msgSend(CPBundle,"mainBundle"),_cf=objj_msgSend(_ce,"principalClass");
if(!_cf){
_cf=objj_msgSend(CPApplication,"class");
}
objj_msgSend(_cf,"sharedApplication");
if(!_cc){
var _cc=objj_msgSend(CPApp,"arguments");
if(objj_msgSend(_cc,"containsObject:","debug")){
CPLogRegister(CPLogPopup);
}
}
if(!_cd){
var _d0=window.location.search.substring(1).split("&");
_cd=objj_msgSend(CPDictionary,"dictionary");
for(var i=0;i<_d0.length;i++){
var _d1=_d0[i].indexOf("=");
if(_d1==-1){
objj_msgSend(_cd,"setObject:forKey:","",_d0[i]);
}else{
objj_msgSend(_cd,"setObject:forKey:",_d0[i].substring(_d1+1),_d0[i].substring(0,_d1));
}
}
}
CPApp._args=_cc;
CPApp._namedArgs=_cd;
...
objj_registerClassPair(_3);
objj_addClassForBundle(_3,objj_getBundleWithPath(OBJJ_CURRENT_BUNDLE.path));
class_addMethods(_4,[new objj_method(sel_getUid("actions"),function(_d3,_d4){
with(_d3){
return [sel_getUid("bootstrapPlatform"),sel_getUid("loadDefaultTheme"),sel_getUid("loadMainCibFile")];
}
}),new objj_method(sel_getUid("performActions"),function(_d5,_d6){
with(_d5){
if(!_d2){
_d2=objj_msgSend(_d5,"actions");
}
while(_d2.length){
var _d7=_d2.shift();
if(objj_msgSend(_d5,_d7)){
return;
}
}
objj_msgSend(CPApp,"run");
}
}),new objj_method(sel_getUid("bootstrapPlatform"),function(_d8,_d9){
with(_d8){
return objj_msgSend(CPPlatform,"bootstrap");
}
}),new objj_method(sel_getUid("loadDefaultTheme"),function(_da,_db){
with(_da){
var _dc=objj_msgSend(objj_msgSend(CPThemeBlend,"alloc"),"initWithContentsOfURL:",objj_msgSend(objj_msgSend(CPBundle,"bundleForClass:",objj_msgSend(CPApplication,"class")),"pathForResource:","Aristo.blend"));
objj_msgSend(_dc,"loadWithDelegate:",_da);
return YES;
}
}),new objj_method(sel_getUid("blendDidFinishLoading:"),function(_dd,_de,_df){
with(_dd){
objj_msgSend(CPTheme,"setDefaultTheme:",objj_msgSend(CPTheme,"themeNamed:","Aristo"));
objj_msgSend(_dd,"performActions");
}
}),new objj_method(sel_getUid("loadMainCibFile"),function(_e0,_e1){
with(_e0){
var _e2=objj_msgSend(CPBundle,"mainBundle"),_e3=objj_msgSend(_e2,"objectForInfoDictionaryKey:",_1)||objj_msgSend(_e2,"objectForInfoDictionaryKey:",_2);
if(_e3){
objj_msgSend(_e2,"loadCibFile:externalNameTable:loadDelegate:",_e3,objj_msgSend(CPDictionary,"dictionaryWithObject:forKey:",CPApp,CPCibOwner),_e0);
return YES;
}
return NO;
}
}),new objj_method(sel_getUid("cibDidFinishLoading:"),function(_e4,_e5,_e6){
with(_e4){
objj_msgSend(_e4,"performActions");
}
})]);
...
p;8;CPFont.jc;3067;
var _1={},_2={},_3="Arial, sans-serif";
_parseFontName=function(_4){
if(objj_msgSend(_4,"isEqualToString:",_3)){
return _4;
}
var _5=_4;
if(_2[_5]){
...
var _7=_4.split(_6);
var _8=/^\s+|\s+$/g;
for(var i=0;i<objj_msgSend(_7,"count");i++){
_7[i]=["'",_7[i].replace(_8,""),"'"].join("");
}
var _9=_7.join(_6+" ");
_2[_5]=_9;
return _9;
};
var _a=objj_allocateClassPair(CPObject,"CPFont"),_b=_a.isa;
class_addIvars(_a,[new objj_ivar("_name"),new objj_ivar("_size"),new objj_ivar("_isBold"),new objj_ivar("_cssString")]);
objj_registerClassPair(_a);
objj_addClassForBundle(_a,objj_getBundleWithPath(OBJJ_CURRENT_BUNDLE.path));
class_addMethods(_a,[new objj_method(sel_getUid("_initWithName:size:bold:"),function(_c,_d,_e,_f,_10){
with(_c){
...
_size=_f;
_isBold=_10;
_cssString=(_isBold?"bold ":"")+ROUND(_f)+"px "+_parseFontName(_e);
_1[_cssString]=_c;
}
return _c;
}
...
class_addMethods(_b,[new objj_method(sel_getUid("fontWithName:size:"),function(_17,_18,_19,_1a){
with(_17){
return _1[(NO?"bold ":"")+ROUND(_1a)+"px "+_parseFontName(_19)]||objj_msgSend(objj_msgSend(CPFont,"alloc"),"_initWithName:size:bold:",_19,_1a,NO);
}
}),new objj_method(sel_getUid("boldFontWithName:size:"),function(_1b,_1c,_1d,_1e){
with(_1b){
return _1[(YES?"bold ":"")+ROUND(_1e)+"px "+_parseFontName(_1d)]||objj_msgSend(objj_msgSend(CPFont,"alloc"),"_initWithName:size:bold:",_1d,_1e,YES);
}
}),new objj_method(sel_getUid("systemFontOfSize:"),function(_1f,_20,_21){
with(_1f){
return _1[(NO?"bold ":"")+ROUND(_21)+"px "+_parseFontName(_3)]||objj_msgSend(objj_msgSend(CPFont,"alloc"),"_initWithName:size:bold:",_3,_21,NO);
}
}),new objj_method(sel_getUid("boldSystemFontOfSize:"),function(_22,_23,_24){
with(_22){
return _1[(YES?"bold ":"")+ROUND(_24)+"px "+_parseFontName(_3)]||objj_msgSend(objj_msgSend(CPFont,"alloc"),"_initWithName:size:bold:",_3,_24,YES);
}
})]);
var _25="CPFontNameKey",_26="CPFontSizeKey",_27="CPFontIsBoldKey";
var _a=objj_getClass("CPFont");
if(!_a){
objj_exception_throw(new objj_exception(OBJJClassNotFoundException,"*** Could not find definition for class \"CPFont\""));
}
var _b=_a.isa;
class_addMethods(_a,[new objj_method(sel_getUid("initWithCoder:"),function(_28,_29,_2a){
with(_28){
return objj_msgSend(_28,"_initWithName:size:bold:",objj_msgSend(_2a,"decodeObjectForKey:",_25),objj_msgSend(_2a,"decodeFloatForKey:",_26),objj_msgSend(_2a,"decodeBoolForKey:",_27));
}
}),new objj_method(sel_getUid("encodeWithCoder:"),function(_2b,_2c,_2d){
with(_2b){
objj_msgSend(_2d,"encodeObject:forKey:",_name,_25);
objj_msgSend(_2d,"encodeFloat:forKey:",_size,_26);
objj_msgSend(_2d,"encodeBool:forKey:",_isBold,_27);
}
})]);
...
p;13;CPTextField.ji;11;CPControl.ji;17;CPStringDrawing.ji;17;CPCompatibility.jc;19995;
...
p;25;_CPBorderlessWindowView.ji;15;_CPWindowView.jc;2558;
var _1=nil;
var _2=objj_allocateClassPair(_CPWindowView,"_CPBorderlessWindowView"),_3=_2.isa;
class_addIvars(_2,[new objj_ivar("_toolbarBackgroundView")]);
objj_registerClassPair(_2);
objj_addClassForBundle(_2,objj_getBundleWithPath(OBJJ_CURRENT_BUNDLE.path));
...
}),new objj_method(sel_getUid("contentRectForFrameRect:"),function(_9,_a,_b){
with(_9){
var _c=objj_msgSend(objj_msgSend(_9,"class"),"contentRectForFrameRect:",_b),_d=objj_msgSend(objj_msgSend(_9,"window"),"toolbar");
if(objj_msgSend(_d,"isVisible")){
toolbarHeight=CGRectGetHeight(objj_msgSend(objj_msgSend(_d,"_toolbarView"),"frame"));
_c.origin.y+=toolbarHeight;
_c.size.height-=toolbarHeight;
}
return _c;
}
}),new objj_method(sel_getUid("frameRectForContentRect:"),function(_e,_f,_10){
with(_e){
var _11=objj_msgSend(objj_msgSend(_e,"class"),"frameRectForContentRect:",_10),_12=objj_msgSend(objj_msgSend(_e,"window"),"toolbar");
if(objj_msgSend(_12,"isVisible")){
toolbarHeight=CGRectGetHeight(objj_msgSend(objj_msgSend(_12,"_toolbarView"),"frame"));
_11.origin.y-=toolbarHeight;
_11.size.height+=toolbarHeight;
}
return _11;
}
})]);
class_addMethods(_3,[new objj_method(sel_getUid("toolbarBackgroundColor"),function(_13,_14){
with(_13){
if(!_1){
_1=objj_msgSend(CPColor,"colorWithPatternImage:",objj_msgSend(objj_msgSend(CPImage,"alloc"),"initWithContentsOfFile:size:",objj_msgSend(objj_msgSend(CPBundle,"bundleForClass:",objj_msgSend(_CPBorderlessBridgeWindowView,"class")),"pathForResource:","_CPToolbarView/_CPToolbarViewBackground.png"),CGSizeMake(1,59)));
}
