...
var _b=objj_allocateClassPair(CPObject,"CPFont"),_c=_b.isa;
class_addIvars(_b,[new objj_ivar("_name"),new objj_ivar("_size"),new objj_ivar("_isBold"),new objj_ivar("_cssString")]);
objj_registerClassPair(_b);
objj_addClassForBundle(_b,objj_getBundleWithPath(OBJJ_CURRENT_BUNDLE.path));
class_addMethods(_b,[new objj_method(sel_getUid("_initWithName:size:bold:"),function(_d,_e,_f,_10,_11){
with(_d){
...
_size=_10;
_isBold=_11;
_cssString=(_isBold?"bold ":"")+ROUND(_10)+"px "+_parseFontName(_f);
_1[_cssString]=_d;
}
return _d;
}
...
}),new objj_method(sel_getUid("cssString"),function(_14,_15){
with(_14){
return _cssString;
}
}),new objj_method(sel_getUid("familyName"),function(_16,_17){
with(_16){
return _name;
}
})]);
class_addMethods(_c,[new objj_method(sel_getUid("fontWithName:size:"),function(_18,_19,_1a,_1b){
with(_18){
return _1[(NO?"bold ":"")+ROUND(_1b)+"px "+_parseFontName(_1a)]||objj_msgSend(objj_msgSend(CPFont,"alloc"),"_initWithName:size:bold:",_1a,_1b,NO);
}
}),new objj_method(sel_getUid("boldFontWithName:size:"),function(_1c,_1d,_1e,_1f){
with(_1c){
return _1[(YES?"bold ":"")+ROUND(_1f)+"px "+_parseFontName(_1e)]||objj_msgSend(objj_msgSend(CPFont,"alloc"),"_initWithName:size:bold:",_1e,_1f,YES);
}
}),new objj_method(sel_getUid("systemFontOfSize:"),function(_20,_21,_22){
with(_20){
return _1[(NO?"bold ":"")+ROUND(_22)+"px "+_parseFontName(_3)]||objj_msgSend(objj_msgSend(CPFont,"alloc"),"_initWithName:size:bold:",_3,_22,NO);
}
}),new objj_method(sel_getUid("boldSystemFontOfSize:"),function(_23,_24,_25){
with(_23){
return _1[(YES?"bold ":"")+ROUND(_25)+"px "+_parseFontName(_3)]||objj_msgSend(objj_msgSend(CPFont,"alloc"),"_initWithName:size:bold:",_3,_25,YES);
}
})]);
var _26="CPFontNameKey",_27="CPFontSizeKey",_28="CPFontIsBoldKey";
var _b=objj_getClass("CPFont");
if(!_b){
objj_exception_throw(new objj_exception(OBJJClassNotFoundException,"*** Could not find definition for class \"CPFont\""));
}
var _c=_b.isa;
class_addMethods(_b,[new objj_method(sel_getUid("initWithCoder:"),function(_29,_2a,_2b){
with(_29){
return objj_msgSend(_29,"_initWithName:size:bold:",objj_msgSend(_2b,"decodeObjectForKey:",_26),objj_msgSend(_2b,"decodeFloatForKey:",_27),objj_msgSend(_2b,"decodeBoolForKey:",_28));
}
}),new objj_method(sel_getUid("encodeWithCoder:"),function(_2c,_2d,_2e){
with(_2c){
objj_msgSend(_2e,"encodeObject:forKey:",_name,_26);
objj_msgSend(_2e,"encodeFloat:forKey:",_size,_27);
objj_msgSend(_2e,"encodeBool:forKey:",_isBold,_28);
}
})]);
