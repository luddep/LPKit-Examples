...
p;10;CPBundle.ji;10;CPObject.ji;14;CPDictionary.ji;14;CPURLRequest.jc;4272;
...
}),new objj_method(sel_getUid("firstEligiblePlatform"),function(_1e,_1f){
with(_1e){
var _20=objj_msgSend(_1e,"objectForInfoDictionaryKey:","CPBundlePlatforms");
return objj_msgSend(_20,"firstObjectCommonWithArray:",OBJJ_PLATFORMS)||nil;
}
}),new objj_method(sel_getUid("connection:didReceiveData:"),function(_21,_22,_23,_24){
with(_21){
if(_23===_21._infoConnection){
info=CPPropertyListCreateFromData(objj_msgSend(CPData,"dataWithString:",_24));
var _25=objj_msgSend(_21,"firstEligiblePlatform");
if(!_25){
throw "Engine not supported for "+objj_msgSend(_21,"bundlePath")+". Supported engines: "+objj_msgSend(_21,"objectForInfoDictionaryKey:","CPBundlePlatforms")+".";
}
objj_msgSend(CPURLConnection,"connectionWithRequest:delegate:",objj_msgSend(CPURLRequest,"requestWithURL:",objj_msgSend(_21,"bundlePath")+"/"+_25+".platform/"+objj_msgSend(_21,"objectForInfoDictionaryKey:","CPBundleExecutable")),_21);
}else{
objj_decompile(objj_msgSend(_24,"string"),_21);
var _26=new objj_context();
if(objj_msgSend(_delegate,"respondsToSelector:",sel_getUid("bundleDidFinishLoading:"))){
_26.didCompleteCallback=function(){
objj_msgSend(_delegate,"bundleDidFinishLoading:",_21);
};
}
var _27=objj_msgSend(objj_msgSend(_21,"objectForInfoDictionaryKey:","CPBundleReplacedFiles"),"objectForKey:",objj_msgSend(_21,"firstEligiblePlatform")),_28=_27?_27.length:0,_29=objj_msgSend(_21,"bundlePath");
while(_28--){
var _2a=_27[_28];
if(_2a.indexOf(".j")===_2a.length-2){
_26.pushFragment(fragment_create_file(_29+"/"+_2a,new objj_bundle(""),YES,NULL));
}
}
if(_26.fragments.length){
_26.evaluate();
}else{
objj_msgSend(_delegate,"bundleDidFinishLoading:",_21);
}
